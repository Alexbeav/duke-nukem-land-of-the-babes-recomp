...
#
# Writes: dist/Duke-Nukem-Land-of-the-Babes-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix Duke-Nukem-Land-of-the-Babes-Recomp \
  --exe-name Duke_Nukem__Land_of_the_Babes_Recompiled \
  --display-name "Duke Nukem: Land of the Babes Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Duke Nukem: Land of the Babes disc" \
