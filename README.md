# Duke Nukem: Land of the Babes Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/duke-nukem-land-of-the-babes-recomp/total)](https://github.com/Alexbeav/duke-nukem-land-of-the-babes-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/duke-nukem-land-of-the-babes-recomp/latest/total)](https://github.com/Alexbeav/duke-nukem-land-of-the-babes-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/duke-nukem-land-of-the-babes-recomp)](https://github.com/Alexbeav/duke-nukem-land-of-the-babes-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Duke Nukem: Land of the Babes** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

This repository provides a source-only Windows setup-host release.
| | |
|---|---|
| Players | 1 |
| Region | USA |
...
Zip prefix for CI artifacts: `Duke-Nukem-Land-of-the-Babes-Recomp`.
...
The `v0.3.3` source uses `Duke_Nukem__Land_of_the_Babes_Recompiled` in CMake, the setup relaunch, and the packager.
