# Duke Nukem: Land of the Babes knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-01002`
...
The source now uses `Duke_Nukem__Land_of_the_Babes_Recompiled` as the only setup executable name. The batch source
