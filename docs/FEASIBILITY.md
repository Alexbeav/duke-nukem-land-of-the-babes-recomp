...
The supported serial set is `SLUS-01002`. The package uses
...
The corrected source uses `Duke_Nukem__Land_of_the_Babes_Recompiled` for CMake, the setup relaunch, and packaging.
