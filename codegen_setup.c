...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "duke-nukem-land-of-the-babes-",
    .project_root_env = "DUKE_NUKEM_LAND_OF_THE_BABES_RECOMP_PROJECT_ROOT",
    .build_dir_env = "DUKE_NUKEM_LAND_OF_THE_BABES_RECOMP_BUILD_DIR",
    .force_setup_env = "DUKE_NUKEM_LAND_OF_THE_BABES_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.02_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Duke_Nukem__Land_of_the_Babes_Recompiled",
    .prepare_note =
